...
public class OldKafkaProducer implements Runnable {
    private static final Logger LOGGER = Logger.getLogger(OldKafkaProducer.class);
    ...
    public static void main(String[] args) throws Exception {
        new Thread(new OldKafkaProducer(Constants.KAFKA_TOPICS)).start();
    }
}