package com.zz.spark.mllib.advance.LdaExtractTopics.Check

import java.util
import java.util.Date

import com.zz.util.NewTime
...
object PredictsDocTopics {
  def main(args: Array[String]) = {
    ...
    val conf = new SparkConf().setMaster("local[2]").setAppName("PredictsDocTopics")
